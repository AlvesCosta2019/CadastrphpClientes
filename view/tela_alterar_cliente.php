...
<form id="frmRegistro" name="form1" action="https://tc2maranguape.com.br/sistema/procedimentos/alterar_foto.php"  method="POST" enctype="multipart/form-data" style="border:1px solid #008000;margin-top:10px;padding:10px;margin-right:0px;background-color:#FF4500;">       
...
<div class="row">
<div class="col-md-12">	
<form id="frmRegistro" name="form1" action="https://tc2maranguape.com.br/sistema/procedimentos/alterar_filiado.php"  method="POST" enctype="multipart/form-data" style="border:1px solid #008000;margin-top:10px;padding:10px;margin-right:0px;background-color:#FF4500;">
