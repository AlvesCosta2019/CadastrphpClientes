...
$arquivo                        = $_POST['arquivo'];
			...
			if(array_search($extensao, $_UP['extensoes'])=== false){		
				echo "
					<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=https://tc2maranguape.com.br/sistema/view/tela_cad_filiado.php'>
...
<html lang="pt-br">
  <head>
	...
	<body>
		...
		if ($sql->rowCount() !=0 ){	
			echo "
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=https://tc2maranguape.com.br/sistema/view/painel_adm.php'>
				<script type=\"text/javascript\">
